...
const PlannerNav = memo(function PlannerNav({ user, onLogout }) {
...
const HeroSection = memo(function HeroSection({ userEmail }) {
  return (
...
const PlannerFooter = memo(function PlannerFooter() {
  return (
...
export default function AppShell({ user, onLogout, children }) {
  return (
    <div className="planner-page">
      <PlannerNav user={user} onLogout={onLogout} />
